...
class GlobalState:
        ...
        def get_word_by_type(self, word_type):
            ...
            def create_sentiment_buttons(user_text):
              ...
              tk.Button(popup, text="Sentiment is Positive", command=handle_positive_sentiment).pack()
            ...
            def get_response_and_save(user_input):
              ...
              messagebox.showinfo("Response", response)
              state = GlobalState()  # Replace the incorrect function call with the GlobalState method
